...
INSERT INTO `abouts` (`id`, `content`, `created_at`, `updated_at`) VALUES
	(1, '<h3>About us<br></h3><p><strong>About Cloth-X</strong></p><p>Welcome to Cloth-X, your go-to destination for all things fashion and beyond! At Cloth-X, we are passionate about helping you express your personal style with high-quality clothing that fits every occasion. From the latest fashion trends to timeless wardrobe staples, our carefully curated collection offers something for everyone. But we don\'t stop there! In addition to our extensive clothing line, we also offer a variety of electronics and accessories, making us a one-stop shop for all your lifestyle needs.</p><p>Our mission at Cloth-X is simple: to provide our customers with an unbeatable shopping experience that combines affordability, quality, and convenience. Whether you\'re refreshing your wardrobe or upgrading your tech, our platform makes it easy to discover great products, all in one place. We take pride in delivering excellent customer service, fast shipping, and a seamless online shopping experience.</p><p>At Cloth-X, we\'re committed to expanding our range to cater to your evolving needs, and we are constantly updating our product offerings to ensure you get access to the latest and greatest in fashion and electronics.</p><p>Thank you for choosing Cloth-X—where style meets innovation!</p><p></p>', '2023-05-01 05:09:53', '2024-09-29 08:18:07');
...
INSERT INTO `chats` (`id`, `sender_id`, `receiver_id`, `message`, `seen`, `created_at`, `updated_at`) VALUES
	(133, 3, 1, 'Hi seller', 1, '2023-12-04 22:52:43', '2024-09-29 08:24:53'),
	(134, 1, 3, 'hi', 0, '2023-12-04 22:55:07', '2023-12-04 22:55:07'),
	(135, 3, 1, 'how are you', 1, '2023-12-04 22:55:50', '2024-09-29 08:24:53'),
...
-- Dumping data for table ecommerce.flash_sale_items: ~5 rows (approximately)
...
INSERT INTO `footer_infos` (`id`, `logo`, `phone`, `email`, `address`, `copyright`, `created_at`, `updated_at`) VALUES
	(1, 'uploads/media_644910333bb80.png', '+1 (156) 145-4818', 'csanduwara1234@gmail.com', 'Panadura, Kaluthara, LK', 'Copyright © 2024  Cloth-X. All Rights Reserved.', '2023-04-26 05:22:10', '2023-04-26 05:51:15');
...
INSERT INTO `general_settings` (`id`, `site_name`, `layout`, `contact_email`, `contact_phone`, `contact_address`, `map`, `currency_name`, `currency_icon`, `time_zone`, `created_at`, `updated_at`) VALUES
	(1, 'Cloth-X', 'LTR', 'csanduwara1234@gmail.com', '0715862119', 'no.261/2,thanthirimulla,panadura', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.1435090089785!2d90.42196781465853!3d23.81349539228068!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c62fb95f16c1%3A0xb333248370356dee!2sJamuna%20Future%20Park!5e0!3m2!1sen!2sbd!4v1639724859199!5m2!1sen!2sbd', 'LKR', 'RS', 'Asia/Colombo', '2023-04-04 00:19:00', '2024-09-29 08:10:40');
...
INSERT INTO `home_page_settings` (`id`, `key`, `value`, `created_at`, `updated_at`) VALUES
	(1, 'popular_category_section', '[{"category":"11","sub_category":null,"child_category":null},{"category":"12","sub_category":null,"child_category":null},{"category":"13","sub_category":null,"child_category":null},{"category":"14","sub_category":null,"child_category":null}]', '2023-04-17 05:40:26', '2024-09-29 08:24:36'),
...
INSERT INTO `logo_settings` (`id`, `logo`, `favicon`, `created_at`, `updated_at`) VALUES
	(1, 'uploads/media_66f95973e8c78.svg', 'uploads/media_645627dd34272.png', '2023-05-06 04:11:41', '2024-09-29 08:13:15');
...
-- Dumping data for table ecommerce.orders: ~5 rows (approximately)
DELETE FROM `orders`;
...
-- Dumping data for table ecommerce.order_products: ~5 rows (approximately)
...
-- Dumping data for table ecommerce.password_reset_tokens: ~2 rows (approximately)
...
-- Dumping data for table ecommerce.product_image_galleries: ~93 rows (approximately)
...
INSERT INTO `sliders` (`id`, `banner`, `type`, `title`, `starting_price`, `btn_url`, `serial`, `status`, `created_at`, `updated_at`) VALUES
	(6, 'uploads/media_6413063a005c8.jpg', 'new arrivals', 'men\'s fashion', '2499', 'http://ecommerce.test/admin/slider/create', 1, 1, '2023-03-16 06:06:18', '2024-09-29 08:15:20'),
	(7, 'uploads/media_6413066df3a6a.jpg', 'new arrivals', 'kid\'s fashion', '690', 'http://ecommerce.test/admin/slider/create', 2, 1, '2023-03-16 06:07:09', '2024-09-29 08:15:29'),
	(8, 'uploads/media_6413069181b0f.jpg', 'Hot Deals', 'winter collection', '4000', 'http://ecommerce.test/admin/slider/create', 3, 1, '2023-03-16 06:07:45', '2024-09-29 08:15:39');
...
INSERT INTO `terms_and_conditions` (`id`, `content`, `created_at`, `updated_at`) VALUES
	(1, '<h3><p><strong>Terms and Conditions</strong></p><p>Welcome to Cloth-X! By using our website (<a rel="noopener" target="_new" href="http://www.cloth-x.com">www.cloth-x.com</a>) and making purchases, you agree to comply with and be bound by the following Terms and Conditions. Please read these carefully before using our services.</p><hr><p><strong>1. General Terms</strong></p><ul><li>By accessing the Cloth-X website, you agree to these Terms and Conditions and our Privacy Policy.</li><li>Cloth-X reserves the right to update or modify these terms at any time without prior notice. Your continued use of the website constitutes your acceptance of any changes.</li><li>You must be at least 18 years old or have parental consent to use this website and make purchases.</li></ul><hr><p><strong>2. Account Registration</strong></p><ul><li>To place an order, you may be required to create an account. You agree to provide accurate and up-to-date information during registration.</li><li>You are responsible for maintaining the confidentiality of your account details and password. Any unauthorized use of your account must be reported immediately.</li><li>Cloth-X reserves the right to suspend or terminate accounts that violate these terms or engage in fraudulent activities.</li></ul><hr><p><strong>3. Product Information</strong></p><ul><li>We strive to ensure that all product descriptions, images, pricing, and availability on the website are accurate. However, errors may occur, and we reserve the right to correct any inaccuracies at any time.</li><li>Product colors may vary slightly due to screen differences. Cloth-X is not responsible for any discrepancies in color representation.</li><li>All electronic items and clothing are subject to availability, and we reserve the right to limit quantities or discontinue products at any time.</li></ul><hr><p><strong>4. Pricing and Payments</strong></p><ul><li>All prices are listed in [currency] and include applicable taxes unless otherwise stated.</li><li>We accept major credit cards, debit cards, and other payment methods as indicated on the website.</li><li>Payment must be made in full at the time of purchase. Cloth-X reserves the right to cancel any orders if payment is not received or cannot be verified.</li></ul><hr><p><strong>5. Shipping and Delivery</strong></p><ul><li>We offer shipping to [locations or regions]. Delivery times are estimated and may vary depending on the destination.</li><li>Once an order is dispatched, you will receive a tracking number via email.</li><li>Cloth-X is not responsible for delays caused by carriers, customs clearance, or other unforeseen circumstances.</li></ul><hr><p><strong>6. Returns and Refunds</strong></p><ul><li>We offer a [X]-day return policy from the date of delivery. To be eligible for a return, the item must be unused and in its original packaging.</li><li>Items such as electronics and certain accessories may have separate return policies or warranties, as specified on the product page.</li><li>Refunds will be issued to the original payment method once the returned item is received and inspected. Shipping fees are non-refundable.</li><li>Items marked as "Final Sale" or "Non-returnable" are not eligible for returns or exchanges.</li></ul><hr><p><strong>7. Intellectual Property</strong></p><ul><li>All content on the Cloth-X website, including but not limited to text, images, logos, and designs, is the property of Cloth-X or its licensors and is protected by copyright, trademark, and other intellectual property laws.</li><li>You may not reproduce, distribute, or use any content from the website without prior written permission from Cloth-X.</li></ul><hr><p><strong>8. Limitation of Liability</strong></p><ul><li>Cloth-X is not liable for any direct, indirect, incidental, or consequential damages arising from the use of our website or products.</li><li>In no event will Cloth-X\'s liability exceed the amount you paid for the product in question.</li><li>Cloth-X does not guarantee that the website will be error-free, uninterrupted, or free of viruses or harmful components.</li></ul><hr><p><strong>9. Privacy Policy</strong></p><ul><li>Your personal information will be handled in accordance with our [Privacy Policy], which outlines how we collect, use, and protect your data.</li></ul><hr><p><strong>10. Governing Law</strong></p><ul><li>These Terms and Conditions are governed by the laws of [Your Country/Region].</li><li>Any disputes arising from the use of Cloth-X or its products will be subject to the exclusive jurisdiction of the courts in [Your Country/Region].</li></ul><hr><p><strong>11. Dispute Resolution</strong></p><ul><li>In case of any disputes or disagreements, we encourage you to contact our customer service team first to attempt to resolve the matter amicably.</li><li>If no resolution is reached, disputes may be handled through mediation, arbitration, or litigation in accordance with the laws of [Your Country/Region].</li></ul><hr><p><b>12. Contact Information\r\nIf you have any questions regarding these Terms and Conditions, feel free to contact us at:</b></p><ul><li>Email:<span style="font-weight: normal;"> </span>[<a rel="noopener">csanduwara1234@gmail.com</a>]</li><li><strong>Phone:</strong> [<span style="font-weight: normal;">+94 71 586 2119</span>]</li><li><strong>Address:</strong> [<span style="font-weight: normal;">no.261/2,thanthirimulla,panadura</span>]</li></ul><hr><p><strong>By using Cloth-X, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.</strong></p></h3><p></p>', '2023-05-01 05:40:38', '2024-09-29 08:21:31');
...
-- Dumping data for table ecommerce.transactions: ~5 rows (approximately)
...
-- Dumping data for table ecommerce.users: ~9 rows (approximately)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `name`, `username`, `image`, `phone`, `email`, `role`, `status`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Admin user123', 'adminuser', '/uploads/1160885760_photo-1628563694622-5a76957fd09c.jpeg', NULL, 'admin@gmail.com', 'admin', 'active', NULL, '$2y$10$NZ0bAGJgRnxBLXmnsU4nlegjVOLxiHsQoWy2hUUEcxJd.9udjRu5K', 'c9bKGAqTHfcAJAY0GRpCapu78z2OxOlwB45SoaoUAjPTz5CZS7vKi9Hh54i8', NULL, '2023-02-25 23:13:13'),
...
INSERT INTO `vendor_conditions` (`id`, `content`, `created_at`, `updated_at`) VALUES
	(1, '<h3>Vendor Terms and Conditions</h3><p><strong>Vendor Terms and Conditions</strong></p><p>These Vendor Terms and Conditions ("Agreement") outline the terms under which vendors ("You" or "Vendor") may sell products on the Cloth-X platform ("Website"). By registering as a vendor and using the Website, you agree to comply with the terms outlined in this Agreement.</p><p><strong>1. Vendor Registration</strong></p><ul><li>All vendors must provide accurate and complete information during registration.</li><li>Cloth-X reserves the right to approve or reject any vendor registration at its discretion.</li></ul><p><strong>2. Product Listings</strong></p><ul><li>Vendors are responsible for accurately listing their products, including descriptions, prices, and availability.</li><li>Products sold on Cloth-X must comply with all applicable laws and regulations.</li><li>Cloth-X reserves the right to remove any product listings that are inaccurate, misleading, or in violation of this Agreement.</li></ul><p><strong>3. Pricing and Payments</strong></p><ul><li>Vendors are responsible for setting the prices of their products.</li><li>Cloth-X will deduct a commission fee (as agreed during registration) from the total sales amount before remitting payment to the vendor.</li><li>Payments will be processed on a [weekly/monthly] basis through the payment method provided by the vendor.</li><li>Vendors must include all applicable taxes in their pricing.</li></ul><p><strong>4. Order Fulfillment</strong></p><ul><li>Vendors are responsible for fulfilling customer orders promptly and accurately.</li><li>Vendors must ensure that products are packaged and shipped within the timeframes specified in the product listings.</li><li>Cloth-X is not responsible for any delays or issues in shipping and delivery.</li></ul><p><strong>5. Returns and Refunds</strong></p><ul><li>Vendors are required to establish clear return and refund policies for their products and must honor these policies.</li><li>Vendors must handle all customer service inquiries related to returns and refunds.</li><li>Cloth-X may mediate disputes between vendors and customers but is not obligated to resolve them.</li></ul><p><strong>6. Vendor Conduct</strong></p><ul><li>Vendors must conduct business ethically and with integrity, ensuring that their interactions with customers and Cloth-X are professional.</li><li>Vendors must not engage in fraudulent or misleading practices, including misrepresenting products or failing to fulfill orders.</li><li>Vendors must maintain the quality and authenticity of the products they sell.</li></ul><p><strong>7. Intellectual Property</strong></p><ul><li>Vendors must have the right to sell the products listed on the Website and must not infringe upon any third-party intellectual property rights.</li><li>Cloth-X is not responsible for any intellectual property infringement claims made against vendors.</li></ul><p><strong>8. Termination</strong></p><ul><li>Cloth-X reserves the right to terminate or suspend a vendor’s account for any violation of this Agreement or any unlawful activity.</li><li>Vendors may terminate their accounts at any time by providing written notice to Cloth-X. Any outstanding orders must still be fulfilled.</li></ul><p><strong>9. Limitation of Liability</strong></p><ul><li>Cloth-X will not be liable for any damages, loss of profits, or other liabilities arising from a vendor\'s use of the Website, except in cases of gross negligence or willful misconduct.</li><li>Vendors agree to indemnify and hold Cloth-X harmless from any claims, damages, or losses arising from their violation of this Agreement or any third-party rights.</li></ul><p><strong>10. Modification of Terms</strong></p><ul><li>Cloth-X reserves the right to modify these Terms and Conditions at any time. Vendors will be notified of significant changes, and continued use of the platform constitutes acceptance of the updated terms.</li></ul><p><strong>11. Governing Law</strong></p><ul><li>This Agreement is governed by the laws of [Your Country/Region], and any disputes arising from it shall be resolved in the jurisdiction of [Your Country/Region].</li></ul><p><strong>12. Dispute Resolution</strong></p><ul><li>Any disputes between Cloth-X and vendors shall first be attempted to be resolved through good faith negotiations.</li><li>If unresolved, disputes may be settled through mediation or arbitration in accordance with the laws of [Your Country/Region].</li></ul><hr><p><strong>By registering as a vendor on Cloth-X, you acknowledge that you have read, understood, and agreed to these Vendor Terms and Conditions.</strong></p><p></p>', '2023-05-01 04:28:03', '2024-09-29 08:16:45');
...
-- Dumping data for table ecommerce.wishlists: ~10 rows (approximately)
